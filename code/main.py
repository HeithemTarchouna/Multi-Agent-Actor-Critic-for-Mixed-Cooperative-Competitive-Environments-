...
if __name__ == '__main__':
    ...
    k_values = [3]  # Add more values if needed

    for env, scenario in zip(envs, scenarios):
        solve_env_with_subpolicies(env, scenario, N_GAMES=25000, evaluate=False, k_values=k_values, plot=True, output_dir=output_dir)
